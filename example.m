%
%{
        This is an example to show how to use the RecursiveModifiedExtendedLeastSquaresWEF (RMELSWEF)
        ...
        input and output vectors with the RMELSWEF algorithm to estimate the
        parameters
...
%% Estimation using RecursiveModifiedExtendedLeastSquaresWEF function
[ theta, Gz_estm ] = RecursiveModifiedExtendedLeastSquaresWEF( u, y, 2, 1, 1, 2, Ts, lambda) % 2nd RELSWEF order estimation
